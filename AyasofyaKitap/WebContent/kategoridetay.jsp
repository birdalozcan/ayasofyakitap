...
<body>
	<%
		...
		if (userName == null)
			...
			String kategoriid = request.getParameter("kategoriinfo");
			for(int i = 0; i<listkategori.size(); i++) {
				if(listkategori.get(i).getKategoriid() == Integer.parseInt(kategoriid)) {
					kategori = listkategori.get(i);
				}
			}			
			ArrayList<Product> listproduct = new ArrayList<Product>();
			listproduct = dao.queryproductforkategori(Integer.parseInt(kategoriid));
        ...
        <li><a href="giris.jsp" class="nav2">Cikis Yap</a></li>
         <li class="divider"></li>
			...
			<div class="center_content">
				...
				<div class="center_title_bar"><%=kategori.getKategoriadi()+" Kategorisi" %></div>
						...
						<div class="prod_box">
							...
							<div class="prod_details_tab">
								<div onclick="addproduct(<%=listproduct.get(i).getUrunindirimlifiyati()%>)"><a href="#" title="header=[Add to cart] body=[&nbsp;] fade=[on]"><img
									src="images/cart.gif" alt="" border="0" class="left_bt" /></a>
									</div>
