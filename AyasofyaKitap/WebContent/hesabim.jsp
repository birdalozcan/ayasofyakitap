...
<div id="main_container">
  ...
  <div id="header">
    <div id="logo"> <a href="index.jsp"><img src="images/logo.png" alt="" border="0" width="237" height="140" /></a> 
    </div>
      ...
      <div class="prod_box_big">
       ...
       <form action="duzenle.jsp" method="post">
          <table border="0" width="100%">
         	<tr>
         		<td align="left" style="font-size:20px;">Adi:</td>
         		<td align="left"><%= rst2.getString("uyeadi") %></td>
         	</tr>
         
         	<tr>
         		<td align="left" style="font-size:20px;">Soyadi: </td>
         		<td align="left"><%= rst2.getString("uyesoyadi") %></td>
         	</tr>
         	
         	<tr>
         		<td align="left" style="font-size:20px;">Email: </td>
         		<td align="left"><%= rst2.getString("email") %></td>
         	</tr>
         	
         	<tr>
         		<td align="left" style="font-size:20px;">Dogum Tarihi: </td>
         		<td align="left"><%= rst2.getString("dogum_tarihi") %></td>
         	</tr>
         	
         	<tr>
         		<td align="left" style="font-size:20px;">Cinsiyet: </td>	
         		<td align="left"><%= rst2.getString("cinsiyet") %>
         		</td>
         	</tr>
         	
         	<tr>
         		<td align="left" style="font-size:20px;">Adres: </td>	
         		<td align="left"><%= rst2.getString("adres") %></td>
         	</tr>
         	
         	<tr>
         		<td align="left" style="font-size:20px;">Sehir: </td>	
         		<td align="left"><%= rst2.getString("sehir_id") %></td>
         	</tr>
         	
         	<tr>
         		<td align="left" style="font-size:20px;">Cep Telefonu: </td>
         		<td align="left"><%= rst2.getString("ceptelefonu") %></td>
         	</tr>
         	
         	<tr>
         		<td align="left" style="font-size:20px;">Ev Telefonu: </td>
         		<td align="left"><%= rst2.getString("evtelefonu") %></td>
         	</tr>
         	
         	<tr>
         		<td align="left" style="font-size:20px;">Sifre: </td>
         		<td align="left"><%= rst2.getString("sifre") %></td>
         	</tr>
         	<tr>
         	 <td align="left">&nbsp;</td>
         	 <td align="left"><input  type="submit"  value="Düzenle"/></td>
            </tr>
         </table>
         <br/>
         </form>
