    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
	        ...
	        <sql:query dataSource="${veriKaynagi}" var="sorgu">
         		...
         		<form name="form2" action="kategoriduzenlesonuc.jsp" method="post">	
                            ...
                            <c:forEach var="satir" items="${sorgu.rows}">
                                    <tbody>
                                        <tr class="odd gradeX">
                                        	...
                                        	<td><input name="kategoriid" class="form-control" id="disabledInput" value="${param.id}"  ></td>
                                            <td><input name="kategoriadi" class="form-control" value="${satir.kategoriadi}"></td>
                                            <td><input name="kategorisirasi" class="form-control" value="${satir.kategorisirasi}"></td>
                                            <td class="center"><input name="kategoriaktif" class="form-control" value="${satir.kategoriaktif}"></td>
