...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Yayinevi Bilgileri</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
	        ...
	        <sql:query dataSource="${veriKaynagi}" var="sorgu">
	                 SELECT * FROM yayinevi WHERE yayinevi_id=?;
    			...
    			<form name="form1" method="post" id="form1"  action="yayineviduzenlesonuc.jsp">	
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <c:forEach var="satir" items="${sorgu.rows}">
                                    <tbody>
                                    	...
                                    	<tr class="odd gradeX">
                                            <th>Yayinevi ID :</th>
                                    	<td><input name="yayineviid" class="form-control" id="disabledInput" value="${param.id}"  ></td>
                                 		</tr>
                                        ...
                                        <tr class="odd gradeX">
                                            <th>Yayinevi Adi :</th>
                                            <td><input name="yayineviadi" class="form-control" value="${satir.yayineviadi}"></td>
                                        </tr> 
                                        
                                        <tr class="odd gradeX">
                                            <th>Yayinevi Kodu :</th>
                                            <td><input name="yayinevikodu" class="form-control" value="${satir.yayinevikodu}"></td>
                                        </tr>  
                                        ...
                                        <tr class="odd gradeX">
                                            <th>Yayinevi Aciklamasi :</th>
                                            <td>
                                            <textarea name="yayineviaciklamasi" class="form-control" rows="3">${satir.yayineviaciklama}</textarea>
