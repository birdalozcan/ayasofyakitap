...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Admin Bilgileri</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
	        ...
	        <sql:query dataSource="${veriKaynagi}" var="sorgu">
	                 SELECT * FROM uyeler WHERE uye_id = 3;
	        </sql:query>
    				
    				
    				
    				
    			<form name="form1" method="post" id="form1"  action="adminprofilduzenlesonuc.jsp">	
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <c:forEach var="satir" items="${sorgu.rows}">
                                    <tbody>
                                 		...
                                 		<tr class="odd gradeX">
                                            <th>ID :</th>
                                            <td><input name="id" class="form-control" value="${satir.uye_id}"></td>
                                        </tr> 
                                 
                                 
                                        <tr class="odd gradeX">
                                            <th>Adı :</th>
                                            <td><input name="adi" class="form-control" value="${satir.uyeadi}"></td>
                                        </tr> 
                                        
                                        <tr class="odd gradeX">
                                            <th>Soyadi :</th>
                                            <td><input name="soyadi" class="form-control" value="${satir.uyesoyadi}"></td>
                                        </tr>  
                                        
                                        <tr class="odd gradeX">
                                            <th>Email :</th>
                                            <td><input name="email" class="form-control" value="${satir.email}"></td>
                                        </tr>  
                                        ...
                                        <tr class="odd gradeX">
                                            <th>Sifre :</th>
                                            <td><input name="sifre" class="form-control" value="${satir.sifre}"></td>
                                        </tr>  
                                         
                         
                                        <tr class="odd gradeX">
                                            <th>Kullanici Adi :</th>
                                            <td><input name="kullaniciadi" class="form-control" value="${satir.kullaniciadi}"></td>
                                        </tr>    
