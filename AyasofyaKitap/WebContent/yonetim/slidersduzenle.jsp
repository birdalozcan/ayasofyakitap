    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
	        ...
	        <sql:query dataSource="${veriKaynagi}" var="sorgu">
	                 SELECT * FROM sliders WHERE sliders_id=?;
    			...
    			<form name="form1" method="post" id="form1"  action="slidersduzenlesonuc.jsp">	
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <c:forEach var="satir" items="${sorgu.rows}">
                                    <tbody>
                                    	...
                                    	<tr class="odd gradeX">
                                            <th>Sliders ID :</th>
                                    	<td><input name="slidersid" class="form-control" id="disabledInput" value="${param.id}"  ></td>
                                 		</tr>
                                        ...
                                        <tr class="odd gradeX">
                                            <th>Sliders Adi :</th>
                                            <td><input name="slidersadi" class="form-control" value="${satir.sliders_adi}"></td>
                                        </tr> 
                                        
                                        <tr class="odd gradeX">
                                            <th>Sliders Sirasi :</th>
                                            <td><input name="sliderssirasi" class="form-control" value="${satir.sliders_sirasi}"></td>
                                        </tr>  
                                        ...
                                        <tr class="odd gradeX">
                                            <th>Sliders Resim :</th>
                                            <td>
                                            <input type="file" name="slidersresim" value="${satir.sliders_resim}">
