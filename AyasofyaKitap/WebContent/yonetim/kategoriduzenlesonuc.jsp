...
<body>
    ...
    <div id="wrapper">
       ...
       try {  
        ...
        String id=request.getParameter("kategoriid");
        
        //KAYDI BURADA DÜZENLE
     String  sqlDuzenle = "UPDATE kategoriler "
         + " SET kategoriadi = ?, "
         + " kategorisirasi = ?, "
         + " kategoriaktif = ? "
   ...
   preparedStatementDuzenle.setString(1, request.getParameter("kategoriadi"));
   preparedStatementDuzenle.setString(2, request.getParameter("kategorisirasi"));
   preparedStatementDuzenle.setString(3, request.getParameter("kategoriaktif"));
