...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="adminprofil.jsp"><i class="fa fa-user fa-fw"></i> User Profile</a>
                        </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Admin Bilgilerim</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
	        ...
	        <sql:query dataSource="${veriKaynagi}" var="sorgu">
    			...
    			<form name="form1" method="post" id="form1"  action="adminprofilduzenle.jsp">	
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <c:forEach var="satir" items="${sorgu.rows}">
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            <th>Sifre :</th>
                                            <td><c:out value="${satir.sifre}"/></td>
                                        </tr>  
                                        
                                        <tr class="odd gradeX">
                                            <th>Kullanici Adi :</th>
                                            <td><c:out value="${satir.kullaniciadi}"/></td>
                                        </tr>  
