                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><c:out value="${satir.email}"/></td>
                                              <td><c:out value="${satir.dogum_tarihi}"/></td>
                                               <td><c:out value="${satir.cinsiyet}"/></td>
                                            <td><c:out value="${satir.adres}"/></td>
                                             <td><c:out value="${satir.ceptelefonu}"/></td>
                                               <td><c:out value="${satir.evtelefonu}"/></td>
                                            ...
                                            <td class="center"> 
                                            				   <a  href="kullanicisil.jsp?id=<c:out value="${satir.uye_id}"/>">Sil</a>
