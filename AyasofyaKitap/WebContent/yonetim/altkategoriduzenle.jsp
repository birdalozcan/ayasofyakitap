    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
	        ...
	        <sql:query dataSource="${veriKaynagi}" var="sorgu">
                 SELECT * FROM alt_kategori WHERE alt_kategori_id=?;
         		...
         		<form name="form2" action="altkategoriduzenlesonuc.jsp" method="post">	
                            ...
                            <c:forEach var="satir" items="${sorgu.rows}">
                                    <tbody>
                                        <tr class="odd gradeX">
                                        	...
                                        	<td><input name="altkategoriid" class="form-control" id="disabledInput" value="${param.id}"  ></td>
                                            <td><input name="anakategoriid" class="form-control" value="${satir.kategori_id}"></td>
                                            <td><input name="altkategoriadi" class="form-control" value="${satir.alt_kategori_adi}"></td>
                                            <td class="center"><input name="altkategorisirasi" class="form-control" value="${satir.alt_kategori_sirasi}"></td>
                                            <td class="center"><input name="altkategoriaktiflik" class="form-control" value="${satir.alt_kategori_aktif}"></td>
