...
<body>
    ...
    <div id="wrapper">
     ...
     String id=request.getParameter("yayineviid");
      ...
      String  sqlDuzenle = "UPDATE sliders "
         + " SET sliders_adi = ?, "
         + " sliders_sirasi = ?, "
         + " sliders_resim = ?"  
         + " WHERE sliders_id = '"+id+"' ";
   ...
   preparedStatementDuzenle.setString(1, request.getParameter("slidersadi"));
   preparedStatementDuzenle.setString(2, request.getParameter("sliderssirasi"));
   preparedStatementDuzenle.setString(3, request.getParameter("slidersresim"));
