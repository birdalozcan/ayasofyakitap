...
<body>
    ...
    <div id="wrapper">
     ...
     String id=request.getParameter("yayineviid");
       
        
        //KAYDI BURADA DÜZENLE
      String  sqlDuzenle = "UPDATE yayinevi "
         + " SET yayineviadi = ?, "
         + " yayinevikodu = ?, "
         + " yayineviaciklama = ? "
         + " WHERE yayinevi_id = '"+id+"' ";
     
        
   preparedStatementDuzenle = conDuzenle.prepareStatement(sqlDuzenle);
   
   preparedStatementDuzenle.setString(1, request.getParameter("yayineviadi"));
   preparedStatementDuzenle.setString(2, request.getParameter("yayinevikodu"));
   preparedStatementDuzenle.setString(3, request.getParameter("yayineviaciklamasi"));
