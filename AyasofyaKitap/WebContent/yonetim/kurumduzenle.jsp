    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
	        ...
	        <sql:query dataSource="${veriKaynagi}" var="sorgu">
	                 SELECT * FROM kurumbilgileri WHERE kurumbilgileri_id=1;
	        </sql:query>
    				
    				
    				
    				
    			<form name="form1" method="post" id="form1"  action="kurumduzenlesonuc.jsp">	
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <c:forEach var="satir" items="${sorgu.rows}">
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            <th>Kurum Adı :</th>
                                            <td><input name="kurumadi" class="form-control" value="${satir.kurum_adi}"></td>
                                        </tr> 
                                        ...
                                        <tr class="odd gradeX">
                                            <th>Telefon :</th>
                                            <td><input name="telefon" class="form-control" value="${satir.telefon}"></td>
                                        </tr>  
                                        
                                        <tr class="odd gradeX">
                                            <th>Adres :</th>
                                            <td>
                                            <textarea name="adres" class="form-control" rows="3">${satir.adres}</textarea>
                                        ...
                                        <tr class="odd gradeX">
                                            <th>Fax :</th>
                                            <td><input name="fax" class="form-control" value="${satir.fax}"></td>
                                        </tr>  
                                         
                         
                                        <tr class="odd gradeX">
                                            <th>Aktiflik :</th>
                                            <td><input name="aktiflik" class="form-control" value="${satir.aktif}"></td>
                                        </tr>    
