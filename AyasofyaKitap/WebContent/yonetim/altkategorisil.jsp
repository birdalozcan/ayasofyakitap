...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Alt Kategoriler</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
    		...
    		<sql:update dataSource="${veriKaynagi}" var="sorgu">
                 DELETE FROM alt_kategori
            	 WHERE alt_kategori_id='${param.id}'
            </sql:update>	
    			
			<c:if test="${sorgu>=1}">
		            <font size="5" color='green'> Veri Silindi</font><br/>
              	<a href="kategoriler.jsp">Kategorilere  Git</a>          
        	</c:if>	
