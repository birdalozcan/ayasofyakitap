...
<body>
    ...
    <div id="wrapper">
     ...
     String  sqlDuzenle = "UPDATE uyeler "
         + " SET uyeadi = ?, "
         + " uyesoyadi = ?, "
         + " email = ?, "
         + " sifre = ?, "
   ...
   preparedStatementDuzenle.setString(1, request.getParameter("adi"));
   preparedStatementDuzenle.setString(2, request.getParameter("soyadi"));
   preparedStatementDuzenle.setString(3, request.getParameter("email"));
   preparedStatementDuzenle.setString(4, request.getParameter("sifre"));
   preparedStatementDuzenle.setString(5, request.getParameter("kullaniciadi"));
