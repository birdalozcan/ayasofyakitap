...
<%@page import="com.ayasofya.adminGiris.*"%>
...
<body>
    ...
    <div id="wrapper">
    	...
    	<%        
          ...
          daoProduct dao = new daoProduct();
  		  ...
  		  int kategoriid = 0;
  		  String kategori = request.getParameter("kategoriselect");
  		  int altkategoriid = 0;
		  String altkategori = request.getParameter("altkategoriselect");
     ...
     String  sqlDuzenle = "UPDATE urunler "
         + " SET kategori_id = ?, "
         + " altkategori_id = ?, "
         + " urunadi = ?, "
         + " urunresmi = ?, "
   ...
   preparedStatementDuzenle.setInt(1, kategoriid);
   preparedStatementDuzenle.setInt(2, altkategoriid);
   preparedStatementDuzenle.setString(3, request.getParameter("urunadi"));
   preparedStatementDuzenle.setString(4, request.getParameter("urunresim"));
   preparedStatementDuzenle.setString(5, request.getParameter("urunkodu"));
   preparedStatementDuzenle.setString(6, request.getParameter("urunetiket"));
   preparedStatementDuzenle.setString(7, request.getParameter("urunindirimli"));
   preparedStatementDuzenle.setString(8, request.getParameter("urunparabirimi"));
   preparedStatementDuzenle.setString(9, request.getParameter("urunaciklama"));
   preparedStatementDuzenle.setString(10, request.getParameter("urunaktif"));
