...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
         		...
         		<div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <c:forEach var="satir" items="${sorgu.rows}">
                                    <tbody>
                                        <tr class="odd gradeX">
                                            <td><c:out value="${satir.yayineviadi}"/></td>
                                            <td><c:out value="${satir.yayinevikodu}"/></td>
                                            
                                    
                                            <td class="center"><c:out value="${satir.yayineviaciklama}"/></td>
                                            <td class="center"><a  href="yayineviduzenle.jsp?id=<c:out value="${satir.yayinevi_id}"/>">Düzenle</a> |
                                            				   <a  href="yayinevisil.jsp?id=<c:out value="${satir.yayinevi_id}"/>">Sil</a>
                                            </td>
                                        </tr>
                                   </tbody>
                                   </c:forEach>
         ...
         <form name="form1" method="post" id="form1"  action="yayinevikontrol.jsp">
					...
					<div >
         		        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
         		        	...
         		        	<tr class="odd gradeX">
                                 <td>Yayinevi Adi</td>
                                 <td><input name="yayineviadi" class="form-control" placeholder="Yayinevi Adini Giriniz"></td>               
                           </tr>
         		        	
         		            <tr class="odd gradeX">
                                 <td>Yayinevi Kodu</td>
                                 <td><input name="yayinevikodu" class="form-control" placeholder="Yayinevi Kodunu Giriniz"></td>               
                           </tr>
         		        	
         		        	
                           
                           <tr class="odd gradeX">
                                 <td>Yayinevi Aciklama</td>
                                 <td><input name="yayineviaciklama" class="form-control" placeholder="Yayinevi Aciklamasini Giriniz"></td>               
                           </tr>
