...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Yayinevleri</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
         		...
         		<div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <c:forEach var="satir" items="${sorgu.rows}">
                                    <tbody>
                                        <tr class="odd gradeX">
                                            <td><c:out value="${satir.sliders_adi}"/></td>
                                            <td><c:out value="${satir.sliders_sirasi}"/></td>
                                            
                                            <td> 
								        	<img  width="100" src="images/<c:out value="${satir.sliders_resim}"/>"
								                  alt="<c:out value="${satir.sliders_resim}"/>"/> 
                							</td>
                                    
                                            
                                            <td class="center"><a  href="slidersduzenle.jsp?id=<c:out value="${satir.sliders_id}"/>">Düzenle</a> |
                                            				   <a  href="sliderssil.jsp?id=<c:out value="${satir.sliders_id}"/>">Sil</a>
                                            </td>
                                        </tr>
                                   </tbody>
                                   </c:forEach>
         ...
         <form  name="form1" method="post" id="form1"  action="sliderskontrol.jsp">
					...
					<div >
         		        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
         		        	...
         		        	<tr class="odd gradeX">
                                 <td>Sliders Adi</td>
                                 <td><input name="slidersadi" class="form-control" placeholder="Sliders Adini Giriniz"></td>               
                           </tr>
         		        	
         		            <tr class="odd gradeX">
                                 <td>Sliders Sirasi</td>
                                 <td><input name="sliderssirasi" class="form-control" placeholder="Sliders Sirasini Giriniz"></td>               
                           </tr>
         		        	
         		        	<tr class="odd gradeX">
                                 <td>Sliders Resim</td>
                                 <td><input  type="file" name="slidersresim"></td>               
                           </tr>
         		        	...
         		        	<tr class="odd gradeX">
                                 <td></td>
                                 <td><input class="btn btn-primary" type="submit" name="sliderskaydet"
									id="gonder" value="Sliders Kaydet"></td>               
                           </tr>
