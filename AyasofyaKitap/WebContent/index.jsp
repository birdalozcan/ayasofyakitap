        ...
        <li><a href="giris.jsp" class="nav2">Cikis Yap</a></li>
         <li class="divider"></li>
			...
			<div class="center_content">
				<div class="center_title_bar">Yeni Urunler</div>
					...
					<% for (int i=0; i<listproduct.size(); i++) { %>
						<div class="prod_box">
							...
							<div class="center_prod_box">
								...
								<div class="product_img">
									<a href="details.jsp?uruninfo=<%=listproduct.get(i).getUrunid()%>"><img width="150" height="150" src="images/<%=listproduct.get(i).getUrunresmi() %>" alt=""
										border="0" /></a>
								</div>
								<div class="prod_price">
							...
							<div class="prod_details_tab">
								<div onclick="addproduct(<%=listproduct.get(i).getUrunindirimlifiyati()%>)"><a href="" title="header=[Add to cart] body=[&nbsp;] fade=[on]"><img
				...
				<div class="center_title_bar">Sizin icin sectiklerimiz</div>
				<% for (int i=0; i<listsecilen.size(); i++) { %>
						<div class="prod_box">
							<div class="top_prod_box"></div>
							<div class="center_prod_box">
								<div class="product_title">
									<a href=""><%=listsecilen.get(i).getUrunadi() %></a>
								</div>
								<div class="product_img">
									<a href="details.jsp?uruninfo=<%=listsecilen.get(i).getUrunid()%>"><img width="150" height="150" src="images/<%=listsecilen.get(i).getUrunresmi() %>" alt=""
										border="0" /></a>
								</div>
								<div class="prod_price">
									<span class="reduce"><%=listsecilen.get(i).getUrunetiketfiyati()+" "+listsecilen.get(i).getUrunparabirimi() %></span> <span class="price"><%=listsecilen.get(i).getUrunindirimlifiyati()+" "+listsecilen.get(i).getUrunparabirimi() %></span>
								</div>
							</div>
							<div class="bottom_prod_box"></div>
						<div class="prod_details_tab">
								<div onclick="addproduct(<%=listsecilen.get(i).getUrunindirimlifiyati()%>)"><a href="" title="header=[Add to cart] body=[&nbsp;] fade=[on]"><img
									src="images/cart.gif" alt="" border="0" class="left_bt" /></a></div>
								<a href="" title="header=[Specials] body=[&nbsp;] fade=[on]"><img
									src="images/favs.gif" alt="" border="0" class="left_bt" /></a> 
								<a href="" title="header=[Gifts] body=[&nbsp;] fade=[on]"><img
									src="images/favorites.gif" alt="" border="0" class="left_bt" /></a>
								<a href="details.jsp?uruninfo=<%=listsecilen.get(i).getUrunid()%>" class="prod_details">details</a>
							</div>
						</div>
				<% } %>
			</div>
			<%
			ArrayList<Product> listquerybox = new ArrayList<Product>();
			listquerybox = dao.querybox(4); 
